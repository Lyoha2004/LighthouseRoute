...
public class Route {
    ...
    /**
     * <p>В данном приватном методе реализуется алгоритм <b><i>Дейкстры с Эвристикой (A*)</i></b>.</p>
     ...
     * доступные из неё вершины, которые потом попадают в границу, сразу же сортируясь по приоритету движения. При
     * этом приоритет рассчитывпется с помощью стоимости проделанного пути и <i>Эвристического метода</i></p>
